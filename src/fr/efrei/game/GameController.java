...
//    private static final Logger log = LoggerFactory.getLogger(GameController.class);
    ...
    private GameTest currTest = null;
    private GameTest nextTest = null;
    ...
    public GameController(GameModel argModel, GamePanel argPanel, UpdateBehavior behavior) {
        model = argModel;
        setFrameRate(DEFAULT_FPS);
        panel = argPanel;
        animator = new Thread(this, "Game");
    ...
    private void addListeners(){
        ...
        model.addTestChangeListener(new GameModel.TestChangedListener() {
            @Override
